...
<form action="#" method="post" enctype="multipart/form-data" class="mt-3 mb-2">
                <div class="lab-inp-cont">
                    ...
                    <input type="text" id="name" name="r_name" placeholder="Enter Your Name" value="<?php echo $row["R_NAME"]  ?>">
                </div>
                <div class="lab-inp-cont">
                ...
                <div class="lab-inp-cont">
                    ...
                    <input type="email" id="email" name="r_email" placeholder="Enter Your Email" value="<?php echo $row["R_EMAIL"]; ?>">         
                </div>
                <div class="lab-inp-cont">
                    <label for="phone">Phone:</label>
                    <input type="number" id="phone" name="r_phone" placeholder="Enter Your Phone" value="<?php echo $row["R_PHONE"]; ?>">
                </div>
                <div class="lab-inp-cont">
